...
public abstract class BaseGun implements Gun {
    ...
    @Override
    public boolean canFire() { return this.getTotalBullets() > 0 ;
    }
    ...
    public int shootFromTotal(int amount){
        if ((this.getTotalBullets() - amount) < 0){
            this.setTotalBullets(0);
            return 0;
        }
        this.setTotalBullets(this.getTotalBullets() - amount);
        return amount;
    }
}
